...
export default function SaaSDashboardProject() {
    return (
        <>
            ...
            <main className="min-h-screen bg-[#fafafa]">
                <section className="mx-auto max-w-6xl px-6">
                    ...
                    <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-600">
                        A modern dashboard concept for managing customers, analytics, and
                        business operations from a single interface.
                    </p>
                    ...
                    <div className="mt-16 overflow-hidden rounded-3xl border border-gray-200 bg-gray-100">
                        <Image
                            src="/projects/saas-dashboard.jpg"
                    ...
                    <div className="mt-20 grid gap-12 md:grid-cols-3">
                        <div>
                            ...
                            <p className="mt-4 leading-7 text-gray-600">
                                Business teams often need to understand important metrics and
                                operational information without navigating through multiple systems.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-4 leading-7 text-gray-600">
                                The dashboard concept organizes key metrics, customer information,
                                and business activity into a focused and easy-to-scan interface.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-4 leading-7 text-gray-600">
                                The result is a dashboard concept that provides a structured view of
                                business information and creates a foundation for future application
                                features.
                            </p>
                        </div>
                    </div>
